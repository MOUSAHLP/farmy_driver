...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'internal_reference' => 'الإشارة الداخلية',
        ...
        'end' => 'النهاية',
        'reason' => 'السبب',
        'confirmed_by' => 'تأكيد من قبل',
        'specialization_id' => 'معرف التخصص',
        'classification_id' => 'معرف التصنيف',
        'compare_type' => 'نوع المقارنة',
        'number_of_patients_min' => 'الحد الأدنى لعدد المرضى',
        'number_of_patients_max' => 'الحد الأقصى لعدد المرضى',
        'lat' => 'خط العرض',
        'lng' => 'خط الطول',
        'is_in_service' => 'في الخدمة',
        'is_new' => 'جديد',
        'fixed_phone' => 'الهاتف الثابت',
        'phone_number' => 'رقم الهاتف',
        'opening_time' => 'وقت الافتتاح',
        'closing_time' => 'وقت الإغلاق',
        'medical_rep_name' => 'اسم المندوب الطبي',
        'target_type_id' => 'معرف نوع الهدف',
        'target_group_id' => 'معرف مجموعة الهدف',
        'report_type_id' => 'معرف نوع التقرير',
        'note' => 'ملاحظة',
        ...
        'time' => 'الوقت',
        'date' => 'التاريخ',
        'work_plan_id' => 'معرف خطة العمل',
        'details' => 'التفاصيل',
        'is_site_match' => 'مطابقة الموقع',
        'work_plan_task_id' => 'معرف مهمة خطة العمل',
        'quantity' => 'الكمية',
        'verification_by' => 'طريقة التحقق',
        'vacation_id' => 'معرف الاجازة',
        'identity' => 'الهوية',
        'code' => 'رمز التحقق',
        ...
        'generated_conversions' => 'التحويلات المُنشأة',
        'responsive_images' => 'صور متجاوبة',
        'order_column' => 'عمود الترتيب',
        'guard_name' => 'اسم الحارس',
        'team_foreign_key' => 'مفتاح الفريق الخارجي',
        'model_morph_key' => 'مفتاح الشكل النموذجي',
        'permissions' => 'الصلاحيات',
        'roles' => 'الأدوار',
        'pivotPermission' => 'الصلاحية المحورية',
        'pivotRole' => 'الدور المحوري',
        'markable_id' => 'معرف العلامة',
        'markable_type' => 'نوع العلامة',
        ...
        'work_plan_visit_id' => 'معرف زيارة خطة العمل',
    ],
