...
return [
    ...
    "orders" => [
        ...
        'code' => 'السائق على مقربة منك هذا هو كود التوصيل الخاص بك',
        'code' => 'قبل اعطاء الكود للسائق تأكد من المنتجات وحدد ما اذا كنت تود إرجاعها من التطبيق',

        'codeError' => 'كود التحقق خاطئ',
    ],
