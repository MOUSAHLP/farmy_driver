...
return [
    ...
    "orders" => [
        ...
        "Confirmed" => [
            "title" => "تم قبول طلبك",
            "body" => "تم قبول طلبك من قبل سائق و سينم البدء في إعداد طلبك"
        ],

        // On Delivery
        "OrderOnWay" => [
            "title" => "طلبك قيد التوصيل",
            "body" => "طلبك الان في طريقه اليك"
        ],
        ...
        "code" => [
            'title' => 'السائق قريب , كود التوصيل الخاص بك:',
            'body' => 'قبل اعطاء الكود للسائق تأكد من المنتجات وحدد ما اذا كنت تود إرجاعها من التطبيق',
            'error' => 'كود التحقق خاطئ',
        ],
